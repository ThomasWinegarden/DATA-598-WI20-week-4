...
#EXTERNAL CODE (SHOULD THIS BE IN SETUP??)
...
```{r, starwars-plot, fig.cap = "A ggplot of starwars stuff", cache=TRUE}
library(tidyverse)
starwars %>%
...
#knitr from class BUT NOW WITH CACHING THAT MAY OR MAY NOT WORK
```{r dependson="starwars=plot", cache=TRUE}
starwars %>%
  filter(species == "Human") %>%
...
#Pasting in bibtex examples to test
```{r bib1}
#---
#references:
#- id: fenner2012a
